...
public class RedisRequestDefinition {
     ...
     * oss的限流参数
     */
    public static RateLimitRequest ossRateLimit = RateLimitRequest.builder()
            .key("oss")
            .max(1)
            .rate(1)
            .build();
     ...
     * 演示基于redis的限流测试A
     */
    public static RateLimitRequest testRateLimitA = RateLimitRequest.builder()
            .key("testA")
            .max(20)
            .rate(10)
            .build();
     ...
     * 演示基于redis的限流测试B
     */
    public static RateLimitRequest testRateLimitB = RateLimitRequest.builder()
            .key("testB")
            .max(10)
            .rate(5)
            .build();
