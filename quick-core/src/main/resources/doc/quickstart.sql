CREATE DATABASE IF NOT EXISTS quickstart DEFAULT CHARACTER SET utf8mb4 DEFAULT COLLATE utf8mb4_general_ci;
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='服务配置中心';
...
CREATE TABLE `user_info` (
  ...
  PRIMARY KEY (`id`)
) ENGINE=InnoDB AUTO_INCREMENT=1621123535259791362 DEFAULT CHARSET=utf8mb4 COMMENT='用户信息';
...
) ENGINE=InnoDB AUTO_INCREMENT=1621146080369430532 DEFAULT CHARSET=utf8mb4 COMMENT='用户登录历史';
...
) ENGINE=InnoDB AUTO_INCREMENT=616764 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='用户数据配置表';
