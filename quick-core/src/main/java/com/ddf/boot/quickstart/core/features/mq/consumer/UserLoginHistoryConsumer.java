package com.ddf.boot.quickstart.core.features.mq.consumer;
...
import com.ddf.boot.quickstart.core.features.mongo.repository.UserLoginHistoryCollectionRepository;
